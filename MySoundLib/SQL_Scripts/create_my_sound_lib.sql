...
GRANT SELECT, SHOW DATABASES ON my_sound_lib.* TO 'msl_user'@'%' WITH
	MAX_QUERIES_PER_HOUR 9999
	MAX_CONNECTIONS_PER_HOUR 999
	MAX_USER_CONNECTIONS 30;
    
GRANT SELECT, INSERT, UPDATE, SHOW DATABASES, DELETE ON my_sound_lib.* TO 'msl_member'@'%' WITH
	MAX_QUERIES_PER_HOUR 9999
	MAX_CONNECTIONS_PER_HOUR 999
	MAX_USER_CONNECTIONS 30;